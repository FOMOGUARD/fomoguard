...
// 구글 번역 공개 엔드포인트(translate.googleapis.com)는 클라우드 IP발 요청을 막아버리는 걸
// 확인해서(실측: "Sorry..." 봇 차단 페이지, 429) 쓰지 않는다. Gemini는 MyMemory가 실패한
// 항목에 한해 최후 보루로만 쓴다(무료 쿼터가 낮아서 - 실측 하루 20건).
